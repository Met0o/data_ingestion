-- external_data.knoema_middle_east_data_latest_record source

CREATE OR REPLACE VIEW external_data.knoema_middle_east_data_latest_record
AS WITH knoema_middle_east_data AS (
        ...
        UNION ALL
         ...
         SELECT DISTINCT ON (knoema_middle_east_data.table_name, knoema_middle_east_data.country_code, knoema_middle_east_data.country, knoema_middle_east_data.variable) knoema_middle_east_data.table_name,
          ...
          ORDER BY knoema_middle_east_data.table_name, knoema_middle_east_data.country_code, knoema_middle_east_data.country, knoema_middle_east_data.variable, knoema_middle_east_data.date DESC
        )
 SELECT latest_data.table_name,
    latest_data.country_code,
    latest_data.country,
    latest_data.variable,
    latest_data.date,
    latest_data.value
   FROM latest_data;