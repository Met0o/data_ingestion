DROP TABLE IF EXISTS external_data.country_data CASCADE;

CREATE SEQUENCE IF NOT EXISTS country_seq;

CREATE TABLE IF NOT EXISTS external_data.country_data (
...
INSERT INTO external_data.country_data (id, iso, name, nicename, iso3, numcode, phonecode) VALUES
...
UPDATE external_data.country_data
